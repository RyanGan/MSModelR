...
sim_data <- as_tibble((rbinom(n, 1, prob = 0.5))) %>% 
  ...
  mutate(Y = rbinom(n, 1, 1/(1+exp(-(-1.5 + -0.6*A)))))
...
## What is a Marginal Structural Model (MSM)?



1. Class of statistical models were first proposed by Robins 2000 to estimate causal effects of a time-dependent exposure accounting for a time-dependent confounder
