#' G-estimation fuction
#' 
#' This function calculates a "causal" estimate of abinary treatment/exposure (a)
#' on an outcome (y). It can calculate the risk difference or risk ratio.
